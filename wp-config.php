...
## These settings should be commented out until after you've activated your wordpress site.
...
# Uncomment if you want to redirect traffic unless requesting a specific blog
//define('NOBLOGREDIRECT', getenv('NOBLOGREDIRECT'));


# Use AWS S3 For Media Assets
