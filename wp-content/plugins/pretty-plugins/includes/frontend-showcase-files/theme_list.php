<div<?php if ( $atts['category'] ) echo ' data-category="'.$atts['category'].'"';?> class="wmd-plugins-showcase plugin-browser<?php if ( $atts['hide_interface'] ) echo ' hide-interface'; if ( $atts['show_buttons'] == 'always' ) echo ' always-show-buttons'; ?>">
	<div class="plugins">
